...
export class EditPostComponent implements OnInit {
  ...
  onSubmit(){
   ...
   // let courseId=this.data.courseId;
      ...
      this.data= {"id" : this.data.id, "reactedPerson" :this.data.reactedPerson,"reportPost":this.data.reportPost ,"like" :this.data.like, "dislike":this.data.dislike, "postOwner":this.data.postOwner, "title":this.newPost.value.title, "body": this.newPost.value.body};
